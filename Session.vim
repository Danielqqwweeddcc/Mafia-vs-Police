...
set shiftwidth=2
set statusline=%F%m%r%w\ [FORMAT=%{&ff}]\ [TYPE=%Y]\ [ASCII=%02.8b]\ [HEX=%02.4B]\ [POS=%04l,%04v][%p%%]\ [LEN=%L]
...
set shortmess=aoO
badd +4 main.html
badd +398 javascript/main.js
badd +12 javascript/tokens.js
args \[BufExplorer]
...
let s:l = 313 - ((0 * winheight(0) + 13) / 27)
